...
for nfp, curves_stel, currents_stel, name in zip(nfp_array, curves_array, currents_array, name_array):
    ...
    fig = plt.figure(figsize = (8, 6))
    plt.bar(X_axis - 0.3, t_B_avg_essos, 0.1, label = r'B ESSOS', color="red", edgecolor="black")
    plt.bar(X_axis - 0.2, t_B_avg_simsopt, 0.1, label = r'B SIMSOPT', color="blue", edgecolor="black")
    plt.bar(X_axis - 0.1, t_dB_by_dX_avg_essos, 0.1, label = r"$B'$ ESSOS", color="red", edgecolor="black")
    plt.bar(X_axis + 0.0, t_dB_by_dX_avg_simsopt, 0.1, label = r"$B'$ SIMSOPT", color="blue", edgecolor="black")
