...
if label == 'toroidal_flux':
    ...
    initial_label = surf.volume
    targetlabel = truevmec.surface.volume
elif label == 'area':
    initial_label = surf.area
    targetlabel = truevmec.surface.area
tol = 1e-6
...
print(f"target label: {label}   target label value: {targetlabel}")
