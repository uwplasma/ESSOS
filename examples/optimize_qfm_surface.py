...
qfm = QfmSurface(field=field, surface=surf,  targetlabel_flux=targetlabel_flux,targetlabel_area=targetlabel_area,targetlabel_volume=targetlabel_volume,label=label)
...
phi_u = jnp.unwrap(jnp.arctan2(traj[:, 1], traj[:, 0]))
