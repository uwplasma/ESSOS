...
def loss_cs_distance(x,surface,dofs_curves,currents_scale,nfp,n_segments=60,stellsym=True,min_distance_cs=1.3):
    ...
    result=jnp.sum(jax.vmap(jax.vmap(cs_distance_pure,in_axes=(0,0,None,None,None)),in_axes=(None,None,0,0,None))(coils.gamma,coils.gamma_dash,surface.gamma,surface.unitnormal,min_distance_cs))
    return result
...
def loss_cs_distance_array(x,surface,dofs_curves,currents_scale,nfp,n_segments=60,stellsym=True,min_distance_cs=1.3):
    coils=coils_from_dofs(x,dofs_curves, currents_scale, nfp,n_segments, stellsym)    
    result=jax.vmap(jax.vmap(cs_distance_pure,in_axes=(0,0,None,None,None)),in_axes=(None,None,0,0,None))(coils.gamma,coils.gamma_dash,surface.gamma,surface.unitnormal,min_distance_cs)
